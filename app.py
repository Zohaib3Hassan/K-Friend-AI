...
/* Hero */
.hero { text-align: center; padding: 1.5rem 1rem 1rem 1rem; }
.hero-badge {
...
.hero h1 {
    ...
    margin: 0.2rem 0; line-height: 1.2; letter-spacing: -0.02em;
}
.hero h1 .hl {
    background: linear-gradient(135deg, var(--primary), #14B88E);
    -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
}
.hero p { color: var(--text-secondary); font-size: 1rem; margin-top: 0.4rem; line-height: 1.5; }
...
with st.sidebar:
    ...
    <div style="text-align:center; padding: 1.5rem 0 0.5rem 0;">
        ...
        <div style="font-size: 1.3rem; font-weight: 800;">K-Friend AI</div>
        <div style="font-size: 0.7rem; color: rgba(255,255,255,0.45); margin-top: 4px; letter-spacing: 0.05em; text-transform: uppercase;">Smart Life Assistant</div>
    </div>
    """, unsafe_allow_html=True)
    st.divider()
    ...
    st.divider()
    st.markdown("**Modules**")
    st.markdown("💬 K-Friend Chat")
    st.markdown("🌐 Translator")
    st.markdown("🛒 Grocery Planner")
    st.markdown("📸 Sign Reader")
    st.markdown("💼 Job Simplifier")
    st.divider()
...
<div class="hero">
    ...
    <h1>Meet your <span class="hl">K-Friend</span></h1>
    <p>Navigate life in South Korea with confidence — chat about visas, translate anything,<br>plan groceries, read Korean signs, and simplify job postings.</p>
</div>
""", unsafe_allow_html=True)
...
with tab_chat:
    st.markdown('<div class="sec-label">Ask anything about life in Korea</div>', unsafe_allow_html=True)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
with tab_translate:
    st.markdown('<div class="sec-label">English ↔ Korean Translation</div>', unsafe_allow_html=True)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
with tab_grocery:
    st.markdown('<div class="sec-label">Weekly Grocery Planning</div>', unsafe_allow_html=True)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
with tab_sign:
    st.markdown('<div class="sec-label">Korean Sign & Menu Photo Reader</div>', unsafe_allow_html=True)
    st.markdown("Upload a photo of any Korean text — street sign, restaurant menu, product label, or notice — and get an instant English translation.")
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
with tab_job:
    st.markdown('<div class="sec-label">Job Posting Simplifier</div>', unsafe_allow_html=True)
    st.markdown("Paste a Korean part-time job posting from Albamon, Saramin, or any site — get a clear English summary with all key details.")
